		...
		<div class="row gx-5 align-items-center">
			...
			<div class="col-lg-5">
				<div class="d-flex align-items-center justify-content-center">
					<img class="img-fluid" src="<?php path('assets/img/waiting-line.svg') ?>" alt="Waiting Line">
				</div>
			</div>
			<!-- Right Item -->
			<div class="col-lg-7">
...
<img class="img-fluid" src="<?php path('assets/img/wave.png') ?>" alt="">
<!-- /Hero Section -->
			...
			<div class="row">
				<div class="d-flex justify-content-center align-items-center gap-5">
					<div class="d-none d-lg-flex col-lg-5">
						<img class="img-fluid" src="assets/img/kyoo-logo.svg" alt="Kyoo Logo">
					</div>
					<div class="col-lg-7">
						<!-- Form -->
