	...
	<script src="<?= ROOT ?>/../resources/js/datatables.js"></script>

	<!-- JQuery Confirm Local JS  -->
	<script src="<?= ROOT ?>/../resources/js/jquery-confirm.js"></script>

	<!-- JQuery Validate Form JS  -->
	<script src="<?= ROOT ?>/../resources/js/validateForm.js"></script>
