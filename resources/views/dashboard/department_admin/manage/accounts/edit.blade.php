                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="edit-accounts-frm" class="row g-3"
                                action="{{ route('manage.department_accounts.update') }}" method="POST" novalidate>
                                ...
                                <div class="text-center">
                                    <a href="{{ route('manage.department_accounts.index') }}" class="btn btn-kyoored">
