/******/ (() => {
  ...
  \*********************************************************/
            /***/ (
                ...
                /* harmony export */ __webpack_require__.d(
                    __webpack_exports__,
                    {
                        ...
                        /* harmony export */ detectOverflow: () =>
                            /* reexport safe */ _utils_detectOverflow_js__WEBPACK_IMPORTED_MODULE_13__[
                                "default"
                            ],
                ...
                /* harmony import */ var _dom_utils_getCompositeRect_js__WEBPACK_IMPORTED_MODULE_9__ =
                    __webpack_require__(
                        /*! ./dom-utils/getCompositeRect.js */ "./node_modules/@popperjs/core/lib/dom-utils/getCompositeRect.js"
                    );
                /* harmony import */ var _dom_utils_getLayoutRect_js__WEBPACK_IMPORTED_MODULE_11__ =
                    __webpack_require__(
                ...
                /* harmony import */ var _dom_utils_getComputedStyle_js__WEBPACK_IMPORTED_MODULE_8__ =
                    __webpack_require__(
                ...
                /* harmony import */ var _utils_debounce_js__WEBPACK_IMPORTED_MODULE_12__ =
                    __webpack_require__(
                        /*! ./utils/debounce.js */ "./node_modules/@popperjs/core/lib/utils/debounce.js"
                    );
                /* harmony import */ var _utils_validateModifiers_js__WEBPACK_IMPORTED_MODULE_5__ =
                    __webpack_require__(
                        /*! ./utils/validateModifiers.js */ "./node_modules/@popperjs/core/lib/utils/validateModifiers.js"
                    );
                /* harmony import */ var _utils_uniqueBy_js__WEBPACK_IMPORTED_MODULE_4__ =
                    __webpack_require__(
                ...
                /* harmony import */ var _utils_detectOverflow_js__WEBPACK_IMPORTED_MODULE_13__ =
                    __webpack_require__(
                ...
                /* harmony import */ var _enums_js__WEBPACK_IMPORTED_MODULE_7__ =
                    __webpack_require__(
                    ...
                    return function createPopper(reference, popper, options) {
                        ...
                        var instance = {
                            ...
                            setOptions: function setOptions(setOptionsAction) {
                                ...
                                if (true) {
                                    var modifiers = (0,
                                    _utils_uniqueBy_js__WEBPACK_IMPORTED_MODULE_4__[
                                        "default"
                                    ])(
                                        [].concat(
                                            orderedModifiers,
                                    ...
                                    if (
                                        ...
                                        _enums_js__WEBPACK_IMPORTED_MODULE_7__.auto
                                    ) {
                                        var flipModifier =
                                            state.orderedModifiers.find(
                                                function (_ref2) {
                                                    var name = _ref2.name;
                                                    return name === "flip";
                                                }
                                    ...
                                    var _getComputedStyle = (0,
                                        _dom_utils_getComputedStyle_js__WEBPACK_IMPORTED_MODULE_8__[
                                            "default"
                                        ])(popper),
                            ...
                            forceUpdate: function forceUpdate() {
                                ...
                                state.rects = {
                                    reference: (0,
                                    _dom_utils_getCompositeRect_js__WEBPACK_IMPORTED_MODULE_9__[
                                        "default"
                                    ])(
                                        reference,
                                        (0,
                                        _dom_utils_getOffsetParent_js__WEBPACK_IMPORTED_MODULE_10__[
                                            "default"
                                        ])(popper),
                                        state.options.strategy === "fixed"
                                    ),
                                    popper: (0,
                                    _dom_utils_getLayoutRect_js__WEBPACK_IMPORTED_MODULE_11__[
                                        "default"
                                    ])(popper),
                            ...
                            update: (0,
                            _utils_debounce_js__WEBPACK_IMPORTED_MODULE_12__[
                                "default"
                            ])(function () {
...
*/
  ...
  \************************************************************/
            /***/ (
                ...
                /* harmony import */ var _dom_utils_contains_js__WEBPACK_IMPORTED_MODULE_9__ =
                    __webpack_require__(
                ...
                function effect(_ref2) {
                    ...
                    if (true) {
                        if (
                            !(0,
                            _dom_utils_instanceOf_js__WEBPACK_IMPORTED_MODULE_8__.isHTMLElement)(
                                arrowElement
                            )
                        ) {
                            console.error(
                    ...
                    if (
                        !(0,
                        _dom_utils_contains_js__WEBPACK_IMPORTED_MODULE_9__[
                            "default"
                    ...
                    if (true) {
                        ...
                        if (
                            ...
                            [
                                ...
                                return (
                                    transitionProperty.indexOf(property) >= 0
                                );
                            })
                        ) {
                            console.warn(
                    ...
                    modifiers.forEach(function (modifier) {
                        []
                            ...
                            .forEach(function (key) {
                                switch (key) {
                                    case "name":
                                        if (typeof modifier.name !== "string") {
                                            console.error(
                                                (0,
                                                _format_js__WEBPACK_IMPORTED_MODULE_0__[
                                                    "default"
                                                ])(
                                    ...
                                    case "phase":
                                        if (
                                            _enums_js__WEBPACK_IMPORTED_MODULE_1__.modifierPhases.indexOf(
                                                modifier.phase
                                            ) < 0
                                        ) {
                                            console.error(
                                                ...
                                                _format_js__WEBPACK_IMPORTED_MODULE_0__[
                                                    ...
                                                    '"phase"',
                                                    "either " +
                                                        _enums_js__WEBPACK_IMPORTED_MODULE_1__.modifierPhases.join(
                                                            ", "
                                                        ),
                                                    '"' +
                                ...
                                modifier.requires &&
                                    modifier.requires.forEach(function (
                                        requirement
                                    ) {
                                        if (
                    ...
                    return new Promise(function dispatchXhrRequest(
                        ...
                        request.ontimeout = function handleTimeout() {
                            var timeoutErrorMessage = config.timeout
                                ...
                                : "timeout exceeded";
                            var transitional =
                                config.transitional || defaults.transitional;
            ...
            /***/ (
                ...
                Object(
                    (function webpackMissingModule() {
                        var e = new Error(
                            "Cannot find module '../sass/app.scss'"
                        );
                        e.code = "MODULE_NOT_FOUND";
                        throw e;
                    })()
                );
                /* harmony import */ var bootstrap__WEBPACK_IMPORTED_MODULE_2__ =
                    __webpack_require__(
            ...
            /***/ (
                ...
                const EventHandler = {
                    ...
                    off(
                        ...
                        for (const keyHandlers of Object.keys(
                            storeElementEvent
                        )) {
                    ...
                    EventHandler.on(
                        ...
                        function (event) {
                            ...
                            const target =
                                ...
                                this.closest(`.${name}`);
                            const instance =
                                component.getOrCreateInstance(target); // Method argument is left, for Alert and only, as it doesn't implement the 'hide' method
                ...
                class ScrollSpy extends BaseComponent {
                    ...
                    _configAfterMerge(config) {
                        ...
                        config.target =
                            getElement(config.target) || document.body; // TODO: v6 Only for backwards compatibility reasons. Use rootMargin only
