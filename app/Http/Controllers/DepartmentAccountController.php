...
class DepartmentAccountController extends Controller
{
    ...
    public function index(HomeController $homeController)
    {
        ...
        return view('dashboard.department_admin.manage.accounts.list', with([
            'user_data' => $user_data,
            'all_data' => $all_data,
        ]));
    }
    ...
    public function fetchAccounts()
    {
        ...
        $accounts = Accounts::with('account_details', 'account_login', 'account_role', 'department')
            ...
            ->where('department_id', $departmentId) // filter by department ID
        ...
        return DataTables::eloquent($accounts)
            ...
            ->addColumn('actions', function ($account) {
                ...
                $viewUrl = route('manage.department_accounts.show', $account->id);
                $editUrl = route('manage.department_accounts.edit', $account->id);
    ...
    public function create(HomeController $homeController)
    {
        ...
        return view('dashboard.department_admin.manage.accounts.add', [
            'user_data' => $user_data,
            'all_data' => $all_data,
        ]);
    }
    ...
    public function show(HomeController $homeController, Request $request)
    {
        ...
        return view('dashboard.department_admin.manage.accounts.view', [
            'user_data' => $homeController->getUserData(),
            'account' => $account
        ]);
    }
    ...
    {
        // Redirect to the View page along with the user's records
        return view('dashboard.department_admin.manage.accounts.edit', [
            'user_data' => $homeController->getUserData(),
            'all_data' => $homeController->getDepartmentAllData(),
            'account' => Accounts::with('account_details', 'account_login', 'account_role', 'department')->findOrFail($request->account_id)
        ]);
